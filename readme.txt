...
Tags: Multiple User Post, multiple user to single post, more editors, admin user roles, more users, single post edit,
...
This plugin will add multiple users to single post. WordPress don't provide you the feature to take a suggestions from different users.
...
== Screenshots ==
1. Admin Screen for selection of users in dropdown
2. Post meta information
3. Assigned user post

== Changelog ==

= 2.0 =
* Add language Translations construct.

= 1.0 =
*  A change since the previous version.

1. Multiple User Post
1. Many editor for single post
1. Enjoy Editing!
